...
public class RelicObject : ScriptableObject
{
    ...
    public virtual void OnTakeDamage(Player player, IBattleEntity attacker, ref int damage, DamageType damageType) { }
    public virtual void OnHeal(Player player, ref int healAmount) { }
